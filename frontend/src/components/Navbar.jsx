...
const [lastScrollY,setLastScrollY] = useState(0);
  ...
  return (
    ...
    ${isScrolled?navbarStyles.navbarScrolled:navbarStyles.navbarDefault}`}>
       ...
       {/*LOGO*/}
       <div className="flex item-center gap-3 select-none">
        <img src={logo} alt="Logo" className='w-12 h-12'/>
        <div className="text-x1 font-bold bg-clip-text text-transparent bg-linear-to-r from-sky-700 to-cyan-600 font-serif leading-[2.9] ">
   SkillForge
        </div>
