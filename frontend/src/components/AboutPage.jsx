...
import { counterTargets, statsMeta, missionVisionValues, teamMembers, values, testimonials } from '../assets/assets/dummyAbout'
import AboutBanner from '../assets/assets/AboutBannerImage.png'
...
<img src={member.image} alt={member.image} className="w-full h-full object-cover rounded-full" />
 </div>
 </div>
...
<a href="/contact" className={aboutUsStyles.ctaButton}><MessageCircleCode className={aboutUsStyles.ctaButtonIcon}/>Tolk to Advisor</a>
  </div>
</div>
</section>
      <style>
