...
import testimonials from '../assets/assets/dummyTestimonial'
import { BadgeCheck, MessageSquareQuote,CalendarDays } from 'lucide-react';
    ...
    <section className={testimonialStyles.section}>
      <div className={testimonialStyles.container}>
        ...
        <p className={testimonialStyles.subtitle}>
          Discover how our learners transformed their careers with hand-on projects and expert mentorship.
        </p>
      </div>
              ...
              <div className={testimonialStyles.content}>
                <div className={testimonialStyles.avatarContainer}>
                  <div className={testimonialStyles.avatarWrapper}>
                    <img src={t.avatar} alt="avatars" className={testimonialStyles.avatarImage} loading="lazy" /></div>
