...
import bannerImg from '../assets/assets/Bannerimage.jpg'
import video from '../assets/assets/BannerVideo.mp4'
        ...
        <div className={bannerStyles.grid}>
          <div className={bannerStyles.leftContent}>
            ...
            <p className={bannerStyles.description}>
              Create beautiful responsive web application with our powerful tool and components. start building your next project today.
            </p>
            {/* features */}
